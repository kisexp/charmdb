...
var host = flag.String("h", "127.0.0.1", "the charmdb server host, default 127.0.0.1")
var port = flag.Int("p", 5200, "the charmdb server part, default 5200")

const cmdHistoryPath = "/Users/huliangliang/Documents/data/go/src/charmdb-cli"
...
func main() {
	...
	cmds := make(map[string]bool, 0)
	for _, cmd := range commands {
		cmds[strings.ToLower(cmd[0])] = true
	}
