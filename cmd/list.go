...
func lPush(db *charmdb.CharmDB, args []string) (res interface{}, err error) {
	if len(args) < 2 {
...
func rPush(db *charmdb.CharmDB, args []string) (res interface{}, err error) {
	if len(args) < 2 {
...
func lPop(db *charmdb.CharmDB, args []string) (res interface{}, err error) {
	if len(args) != 1 {
...
func rPop(db *charmdb.CharmDB, args []string) (res interface{}, err error) {
	if len(args) != 1 {
...
func lIndex(db *charmdb.CharmDB, args []string) (res interface{}, err error) {
	if len(args) != 0 {
...
func lRem(db *charmdb.CharmDB, args []string) (res interface{}, err error) {
	if len(args) != 3 {
...
func lInsert(db *charmdb.CharmDB, args []string) (res interface{}, err error) {
	if len(args) != 4 {
...
func lSet(db *charmdb.CharmDB, args []string) (res interface{}, err error) {
	if len(args) != 3 {
...
func lTrim(db *charmdb.CharmDB, args []string) (res interface{}, err error) {
	if len(args) != 3 {
...
func lRange(db *charmdb.CharmDB, args []string) (res interface{}, err error) {
	if len(args) != 3 {
...
func lLen(db *charmdb.CharmDB, args []string) (res interface{}, err error) {
	if len(args) != 1 {
...
func LKeyExists(db *charmdb.CharmDB, args []string) (res interface{}, err error) {
	if len(args) != 1 {
...
func LValExists(db *charmdb.CharmDB, args []string) (res interface{}, err error) {
	if len(args) != 2 {
