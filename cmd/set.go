...
func sAdd(db *charmdb.CharmDB, args []string) (res interface{}, err error) {
	if len(args) <= 1 {
...
func sPop(db *charmdb.CharmDB, args []string) (res interface{}, err error) {
	if len(args) != 2 {
...
func sIsMember(db *charmdb.CharmDB, args []string) (res interface{}, err error) {
	if len(args) != 2 {
...
func sRandMember(db *charmdb.CharmDB, args []string) (res interface{}, err error) {
	if len(args) != 2 {
...
func sRem(db *charmdb.CharmDB, args []string) (res interface{}, err error) {
	if len(args) <= 1 {
		err = ErrSyntaxIncorrect
		return
	}
...
func sMove(db *charmdb.CharmDB, args []string) (res interface{}, err error) {
	if len(args) != 3 {
...
func sCard(db *charmdb.CharmDB, args []string) (res interface{}, err error) {
	if len(args) != 1 {
...
func sMembers(db *charmdb.CharmDB, args []string) (res interface{}, err error) {
	if len(args) != 1 {
...
func sUnion(db *charmdb.CharmDB, args []string) (res interface{}, err error) {
	if len(args) <= 0 {
...
func sDiff(db *charmdb.CharmDB, args []string) (res interface{}, err error) {
	if len(args) <= 0 {
